...
* Aktywność - studenci narzekają, że czasem aktywność to spora część oceny. Np. na Metodach Optymalizacji są dwa kolokwia za 45 pkt oraz aktywność za 10 pkt i z tego wylicza się ocene; można poprawić kolokwia, przychodząc na egzamin za 90 pkt; ale zawsze te 10 pkt za aktywność jest jaka była przez cały semestr. Studentom się to nie podoba, bo jeśli ktoś jest nieśmiały i boi się podejść do tablicy, to ma od razu trudniej, bo tak naprawdę ma -10 pkt możliwych do zdobycia. Otóż tak jest by design. Jeśli ktoś boi się podejść do tablicy i obronić swoje rozwiązanie, to ma mu być trudniej zdać. Wydział chce, żeby absolwent umiał opowiadać o tym co zrobił i bronić swojego rozwiązania. Wydział chce, żeby student ćwiczył myślenie przy tablicy. Ktoś może zapytać: "No dobra, ale czy to jest kluczowa umiejętność absolwenta MiNI?" i jest na to prosta odpowiedź: nie jest. Dlatego 10% oceny od tego zależy, a nie 100%.
